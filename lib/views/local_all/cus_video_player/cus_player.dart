...
import 'cus_controls.dart';

class CusPlayer extends StatefulWidget {
  const CusPlayer({
    super.key,
  ...
  @override
  State createState() => _CusPlayerState();
}

class _CusPlayerState extends State<CusPlayer> {
                ...
                : currentFile != null
                    ? SizedBox(
                        ...
                        height: isCusFullscreen
                            ? 1.sh
                            : currentEntity.size.height /
                                (ScreenUtil().pixelRatio ?? 1),
                        width: isCusFullscreen
                            ? 1.sw
                            : currentEntity.size.width /
                                (ScreenUtil().pixelRatio ?? 1),
